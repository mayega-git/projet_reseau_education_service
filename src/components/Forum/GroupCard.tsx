...
import type { DiscussionGroup } from '@/app/forum-app/lib/types';
  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-3">
        <h3 className="h6-bold text-black-500 group-hover:text-primary-purple-600 transition-colors">{group.name}</h3>
        <div className="w-8 h-8 rounded-full bg-grey-50 flex items-center justify-center group-hover:bg-primary-purple-50 transition-colors">
          <ChevronRight className="w-5 h-5 text-black-200 group-hover:text-primary-purple-500 transition-all" />
        </div>
      </div>
