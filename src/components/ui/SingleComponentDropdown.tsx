...
interface SingleSelectDropdownProps {
  choices: CategoryInterface[]; // Array of categories to choose from
  selectedChoiceId: string; // Selected category ID (string) from parent
      ...
      >
        <div className="flex flex-wrap gap-2">
          {selectedChoiceId ? (
            ...
            >
              {
                choices.find((category) => category.id === selectedChoiceId)
                  ?.name
              }
              <X
                size={14}
