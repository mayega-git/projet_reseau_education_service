...
public class CategoryController {
    ...
    public Mono<ResponseEntity<Category_entity>> updateCategory(@PathVariable String categoryId, @RequestBody CategoryCreateDTO categoryCreateDTO) {
    ...
    public Flux<Category_entity> getAllCategories() {
            ...
            return categoryService.getAllCategories()
                .onErrorResume(Exception.class, e -> {
                    return Flux.error(new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "Erreur serveur lors de la récupération des catégories", e));
        });
    }
    ...
    public Mono<String> getCurrentDatabaseName() {
        ...
        return databaseClient.sql("SELECT current_database()")
                ...
                .onErrorResume(e -> Mono.just("Error connecting to database: " + e.getMessage())); // Gestion d'erreur
    }*/
