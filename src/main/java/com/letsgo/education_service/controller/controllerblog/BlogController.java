...
public class BlogController {
    ...
    public Mono<ResponseEntity<Blog_entity>> getBlogById(@PathVariable String id) {
    ...
    public Mono<ResponseEntity<Blog_entity>> publishBlog(@PathVariable String id) {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Audio du blog mis à jour avec succès"),
            @ApiResponse(responseCode = "404", description = "Blog non trouvé"),
    ...
    @Operation(summary = "Mettre à jour l'image de couverture du blog ou ajouter une image de couverture au blog")
    @ApiResponses({
