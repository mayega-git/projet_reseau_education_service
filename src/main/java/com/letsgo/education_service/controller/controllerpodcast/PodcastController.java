...
/* 
    ...
    public Flux<?> getAllPodcasts(
            ...
            return podcastService.getPodcastByFilters(authorId, status, domain, categoryId, tags, organisationId, title);
    }
...
*/      
 ...
 //erreur
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Image ajoutée avec succès"),
            @ApiResponse(responseCode = "404", description = "Podcast non trouvé")
    })
    ...
    @Operation(summary = "Supprimer un podcast par son Id (l'action de suppression est traitée comme une archive)")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Podcast supprimé avec succès"),
            @ApiResponse(responseCode = "404", description = "Podcast non trouvé"),
            @ApiResponse(responseCode = "400", description = "Le podcast est déjà supprimé")
    })
    ...
    public Mono<ResponseEntity<Flux<DataBuffer>>> streamPodcast(@PathVariable String podcastId) {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Podcast mis à jour avec succès"),
            @ApiResponse(responseCode = "404", description = "Podcast non trouvé")
    })
   ...
   /*  @PatchMapping("/{id}/uploadCover")
    @Operation(summary = "Uploader une image de couverture pour un podcast existant")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Image de couverture mise à jour avec succès"),
            @ApiResponse(responseCode = "404", description = "Podcast non trouvé")
    })
     public Mono<ResponseEntity<Podcast_entity>> uploadCoverImg(
        @PathVariable String id,
...
/* 
    ...
    public ResponseEntity<Flux<DataBuffer>> streamCoverImage(@PathVariable String id) {
